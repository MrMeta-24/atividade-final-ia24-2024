...
const btClose = imgModalGaleria.querySelector('.botão-fechar')
...
const btProx = imgModalGaleria.querySelector('.botão-posterior')
 let imgProx = null
 ...
 const btAnt = imgModalGaleria.querySelector('.botão-anterior')
 let imgAnt = null
